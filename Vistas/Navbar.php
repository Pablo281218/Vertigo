		...
		<nav class="navbar navbar-inverse colornav container-fluid">
		      ...
		      <?php
			      ...
			      if ($_SESSION['Usuario']=="pablo") {
				   ...
				   <?php 	
						 if ($_SESSION['Usuario']=="pablo"){ 
					echo ('<div class="container input-group-btn input-group navbar-form navbar-right dropdown"><button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" style="color: #000 ; background: #FFF"> Bienvenido, administrador
			  	 	...
			  	 	echo ('<div class="container input-group-btn input-group navbar-form navbar-right"><button type="button" class="btn" style="color: #000 ; background: #FFF"><a href="http://localhost/html/Vertigo/Vistas/login.php">Iniciar sesion</a></button></div>');
							}	?>
